...
func (d Docker) listContainersWithState(state string) ([]Container, error) {
...
func PrintListContainers(state string) error {
	...
	containers, err := d.listContainersWithState(state)
	if err != nil {
		return err
	}
	data := [][]string{}
...
func (d Docker) convertContainerNameToId(name string) (string, error) {
